...
const Works = () => {
  return (
    <div id="Works">
      ...
      <WorksImg id="lector-textos" img="https://firebasestorage.googleapis.com/v0/b/portfolio-3e2be.appspot.com/o/img%2FCaptura%20de%20pantalla%202024-04-05%20a%20la(s)%206.53.39%E2%80%AFp.%C2%A0m..png?alt=media&token=2caf0a77-6bdd-4615-91b0-7065a495c436" titulo="lector de textos" href="https://lector-de-textos.netlify.app/" label="This project is a simple web page that allows you to enter text in a textarea, translate it, and reproduce it in different selectable languages. It uses JavaScript to interact dynamically with the HTML and CSS for design." go="Click and go to the Page"/>
    </div>
  )
