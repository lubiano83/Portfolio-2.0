  ...
  return (
    <div id="Works">
      ...
      <div className="Works__container">
        ...
        <WorksImg id="barra-central" img="https://firebasestorage.googleapis.com/v0/b/portfolio-3e2be.appspot.com/o/img%2Fbarra-central.webp?alt=media&token=51e53007-28bb-4559-818d-cff72b7d5734" titulo="barra central" href="https://barra-central.netlify.app/" label="Project completed in the Application Development Course at CoderHouse, where I ranked within the top 1. The main tools utilized include React Native, SQLite, Google Maps, Redux, Yup, Expo and others." go="Click and go to the Page"/>
      </div>
    </div>
  )
